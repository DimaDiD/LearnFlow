...
try
{
    Log.Information("Starting Certificates Service...");
    ...
    builder.Host.UseSerilog((context, services, configuration) => configuration
        ...
        .Enrich.WithProperty("Service", "certificates-service")
    ...
    builder.Services.AddAutoMapper(typeof(CertificateMappingProfile).Assembly);
...
{
    Log.Fatal(ex, "Certificates Service failed to start.");
}
finally
{
    Log.CloseAndFlush();
